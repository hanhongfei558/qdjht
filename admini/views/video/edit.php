...
<form name="form1" enctype="multipart/form-data" method="post" action="?a=edit&p=<?php echo $request['p'] ?>&n=<?php echo $request['n'] ?>">
  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="admintb">
    <tr class="adtbtitle">
      <td width="892"><h3>修改视频：</h3><a href="javascript:history.back(1)" class="creatbt">返回</a></td>
    ...
    <tr>
      <td colspan="2" bgcolor="#FFFFFF"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="4">
          <tr>
            <td width="57">标题</td>
            <td width="90%"><input type="text" class="txt" name="title" value="<?php echo $video_item->title ?>" id="title" size="60">
              给您上传的视频起个名字 </td>
          </tr>
          <tr>
            <td width="57">视频文件</td>
            <td><input name="filePath" id="filePath" type="text" class="txt" value="<?php echo $video_item->filePath ?>" size="60">
            ...
            <td colspan="2"><a href="javascript:showHide('field_pane_on_2')"><img src="images/expand.gif" border="0"> 填写关键词&摘要 </a><a href="http://www.doccms.com/seo/#guanjianzi" target="_blank"><img src="./images/help.gif" alt="不知道怎么写关键字？" border="0" /></a>
              <div id="field_pane_on_2" style="display: none; padding:0; margin:0;">
                <table width="100%" border="0" align="center" cellpadding="0">
                  <tr>
                    <td> 页面关键词：</td>
                    <td width="90%"><textarea style='width:400px;' name='keywords' id='keywords' cols='90' rows='3'><?php echo $video_item->keywords ?></textarea></td>
                  </tr>
                  <tr>
                    <td> 页面摘要：</td>
                    <td><textarea style='width:400px;' name='description' id='description' cols='90' rows='3'><?php echo $video_item->description ?></textarea></td>
                  </tr>
                </table>
              </div></td>
          </tr>
          <tr>
            <td width="80">视频描述</td>
            <td><?php echo ewebeditor(EDITORSTYLE,'content',$video_item->content)?></td>
          </tr>
        </table></td>
    </tr>
  </table>
