...
#newsconttitle p{ width:100%; height:20px; line-height:20px; float:left; padding:15px 0; margin:0; color:#333; border-bottom:1px #ddd solid; text-align:left;}
...
#newcontent{ line-height:22px; color:#666; margin:10px 5px 0 5px; float:left; display:inline; font-size: 14px; line-height: 22px;}
#newcontent p{ padding:0; margin:0; padding: 3px 0;}
...
#articleHeader h4{font-size:12px; color:#666; height:20px;}
#articleHeader h4 a{ font-size:12px; color:#666}
