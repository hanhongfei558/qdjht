...
<div class="c-box clearfix">
  ...
  <div class="col2-rbox">
    <form name="form1" method="post" action="./index.php?a=update&p=<?php echo $request['p'] ?>&i=<?php echo $request['i'] ?>" enctype="multipart/form-data" >
      <div class='box' >
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="4">
          <tr>
            <td width="60">页面标题</td>
            <td width="90%"><input type="text" name="title" id="title" class="txt" style="width:60%" value="<?php echo $article->title ?>" />
              <a href="http://www.doccms.com/seo/#biaoti" target="_blank"><img src="./images/help.gif" border="0" alt="页面标题SEO中的作用" /></a> 顺序
              <input type="text" name="pageId" id="pageId" class="txt" style="width:24px" value="<?php echo $article->pageId; ?>" />
          ...
          <tr>
            <td colspan="2" valign="top"><?php echo ewebeditor(EDITORSTYLE,'content',$article->content); ?></td>
          </tr>
          <tr>
