...
#newlist li a{ background:url(<?php echo $tag['path.skin']; ?>res/images/list_a.gif) 6px 7px no-repeat; color:#666; padding:0 0 0 25px;}
#newlist li a:hover{ background:url(<?php echo $tag['path.skin']; ?>res/images/list_l.gif) 6px 7px no-repeat; color:#333;}
